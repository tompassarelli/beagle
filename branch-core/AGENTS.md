# branch-core repository instructions

branch-core is Beagle's in-repo store engine. These instructions govern this
...
license identifier, and practical implication for branch-core. A dated record applies
only to the revision checked; never treat it as evergreen.

- 2026-07-22 — Datahike revision
  `7dd5324781ee8454608418c7e7d7b26c48b5fe2e` is EPL-1.0; branch-core revision
...
- 2026-07-29 — Beagle revision
  `0d6e712f5b829545bb82cb3a9e0b77853a9521a0` is MIT OR Apache-2.0. branch-core
  ...
  branch-core under either offered license.
...
- 2026-08-15 — Beagle packaged-input revision
  ...
  runtime pin and is license-compatible with branch-core; update this dated record
...
- 2026-08-11 — TypeScript npm package `6.0.3`, source revision
  `050880ce59e30b356b686bd3144efe24f875ebc8`, is Apache-2.0. branch-core uses it
...
- 2026-08-11 — Bun `1.3.13` and `bun-types` `1.3.13`, source revision
  ...
  branch-core uses the pinned Bun binary as the official JavaScript-client runtime,
...
- 2026-08-11 — `oven-sh/setup-bun` revision
  `0c5077e51419868618aeaa5fe8019c62421857d6` is MIT. branch-core uses it only in
...
- 2026-08-12 — Wrangler npm package `4.121.0` and Miniflare npm package
  ...
  are respectively MIT OR Apache-2.0 and MIT. branch-core uses these exact packages
...
- 2026-08-12 — workerd npm package `1.20260804.1`, source revision
  ...
  `4.121.0` selects this exact runtime build. branch-core invokes it indirectly through
...
- 2026-08-12 — `cachix/install-nix-action` revision
  `630ae543ea3a38a9a4166f03376c02c50f408342` is Apache-2.0. branch-core uses it only
