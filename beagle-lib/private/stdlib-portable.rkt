...
(define STDLIB-PORTABLE
  (hash
   ...
   ;; --- explicit host collection boundary -----------------------------------
   'aget       (fn-of '((U JsArray JsObject) Any) 'Any #:rest 'Any)
   'aset       (fn-of '((U JsArray JsObject) Any Any) 'Any #:rest 'Any)
   'alength    (fn-of '(JsArray) 'Int)
   'array      (fn-of '() 'JsArray #:rest 'Any)
   'js-obj     (fn-of '() 'JsObject #:rest 'Any)
   'into-array (fn-of '(Any) 'JsArray #:rest 'Any)
   'object-array (fn-of '(Any) 'JsArray)
   'js-keys    (fn-of '(JsObject) 'JsArray)
   'js-delete  (fn-of '(JsObject Any) 'Bool)
   'js-in      (fn-of '(Any JsObject) 'Bool)
   'clj->js    (fn-of '(Any) 'Any)
   'js->clj    (fn-of '(Any) 'Any)
   'to-array   (fn-of '(Any) 'JsArray)
