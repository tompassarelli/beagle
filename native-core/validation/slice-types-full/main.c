...
int main(void) {
  ...
  native_m0_type_2 *triple =
      native_arena_alloc(&arena, sizeof(*triple), _Alignof(native_m0_type_2));
  if (triple == NULL) {
    return 2;
  }
  ...
  native_m0_type_3 *triple_b =
      native_arena_alloc(&arena, sizeof(*triple_b), _Alignof(native_m0_type_3));
