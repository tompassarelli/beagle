...
int main(void) {
  ...
  native_m0_type_17 version_values[] = {{
      .tag = INT64_C(1),
      .payload = {.variant_1 = INT64_C(19)},
  }};
  native_m0_type_17 version_text_values[] = {{
      .tag = INT64_C(0),
      .payload = {
  ...
  native_m0_type_15 error_values[] = {{
      .tag = INT64_C(0),
      .payload = {
          .variant_0 = (uint64_t)(uintptr_t)&unknown_op,
      },
  ...
  native_m0_type_12 rejection = native_vec_new(
  ...
  rejection = native_vec_push(
      &arena, rejection, &rejection_item, INT64_C(8), _Alignof(uint64_t));
  native_m0_type_19 reject_values[] = {{
      .tag = INT64_C(3),
  ...
  native_map *versioned = native_map_from_arrays(
      ...
      sizeof version_values[0], _Alignof(native_m0_type_17),
  ...
  native_map *version_text = native_map_from_arrays(
      ...
      sizeof version_keys[0], _Alignof(uint64_t),
      sizeof version_text_values[0], _Alignof(native_m0_type_17),
      NATIVE_COLLECTION_EQ_KEYWORD);
  native_map *version_missing = native_map_from_arrays(
      ...
      _Alignof(native_m0_type_17), NATIVE_COLLECTION_EQ_KEYWORD);
  native_map *optional_error = native_map_from_arrays(
      ...
      _Alignof(native_m0_type_15), NATIVE_COLLECTION_EQ_KEYWORD);
  ...
  native_map *rejected = native_map_from_arrays(
      ...
      _Alignof(native_m0_type_19), NATIVE_COLLECTION_EQ_KEYWORD);
  ...
  native_m0_type_13 optional_nil = native_m0_fn_8(optional_error);
  native_m0_type_13 optional_map = native_m0_fn_8(optional_empty);
  ...
  native_m0_type_14 other_key = native_m0_fn_11(present);
  native_m0_type_14 other_source = native_m0_fn_12(present, missing);
  if (other_key.tag != INT64_C(1) || other_source.tag != INT64_C(1)) {
    return 9;
  }
  native_m0_type_14 false_missing = native_m0_fn_13(missing);
  native_m0_type_14 false_present = native_m0_fn_13(present);
