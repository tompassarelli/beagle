...
;; ============================================================================
;; Boots ONE warm code server over a /tmp COPY of .store/code.log on a verified-free
...
(when-not (.exists (io/file code-log))
  (println "SKIP — no .store/code.log (run bin/beagle-store-ingest-code first)") (System/exit 0))
