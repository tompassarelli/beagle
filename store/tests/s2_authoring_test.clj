...
(def input (java.io.File/createTempFile "store-s2-authoring-" ".edn"))
(def output (java.io.File/createTempFile "store-s2-projection-" ".edn"))
(def automatic-output-dir
  (.toFile
   (java.nio.file.Files/createTempDirectory
    "store-s2-automatic-projection-"
...
(def candidate-position-key
  (deref (ns-resolve 'store.candidate-transformer 'position-key)))
