# store repository instructions

store is Beagle's in-repo store engine. These instructions govern this
subtree; they do not describe a standalone repository, installation, product,
...
license identifier, and practical implication for store. A dated record applies
only to the revision checked; never treat it as evergreen.

- 2026-07-22 — Datahike revision
  `7dd5324781ee8454608418c7e7d7b26c48b5fe2e` is EPL-1.0; store revision
...
- 2026-07-29 — Beagle revision
  `0d6e712f5b829545bb82cb3a9e0b77853a9521a0` is MIT OR Apache-2.0. store
...
- 2026-08-21 — Beagle packaged-input revision
  `ca658a17428a1785e0586de512d10b9bf499632c` is MIT OR Apache-2.0. It is
...
- 2026-08-11 — TypeScript npm package `6.0.3`, source revision
  `050880ce59e30b356b686bd3144efe24f875ebc8`, is Apache-2.0. store uses it
...
- 2026-08-11 — Bun `1.3.13` and `bun-types` `1.3.13`, source revision
  ...
  store uses the pinned Bun binary as the official JavaScript-client runtime,
  package tool, and test runner, and its type package only in the packed-client
  CI gate; neither is shipped with `@tompassarelli/beagle-store-rpc`. Do not vendor Bun
  components without reviewing the applicable component license.

- 2026-08-11 — `oven-sh/setup-bun` revision
  `0c5077e51419868618aeaa5fe8019c62421857d6` is MIT. store uses it only in
...
- 2026-08-12 — Wrangler npm package `4.121.0` and Miniflare npm package
  ...
  are respectively MIT OR Apache-2.0 and MIT. store uses these exact packages
  ...
  shipped by `@tompassarelli/store-cloudflare-do`, and no Cloudflare source is
  copied into store.
...
- 2026-08-12 — workerd npm package `1.20260804.1`, source revision
  ...
  `4.121.0` selects this exact runtime build. store invokes it indirectly through
...
- 2026-08-12 — `cachix/install-nix-action` revision
  `630ae543ea3a38a9a4166f03376c02c50f408342` is Apache-2.0. store uses it only
