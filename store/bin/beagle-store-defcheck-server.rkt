#lang racket/base
;; ============================================================================
;; beagle-store-defcheck-server — persistent, warm Beagle def-level checker.
;; ============================================================================
...
;; adapter-v2 ERROR shape. Run under the pinned beagle racket (bin/beagle-store-defcheck).
;; ============================================================================
...
(define (serve port)
  ...
  (printf "beagle-store-defcheck-server: ready on 127.0.0.1:~a\n" port)
  (flush-output)
  (let loop ()
...
(module+ main
  ...
  (when (null? argv)
    (eprintf "usage: beagle-store-defcheck-server <port>\n")
    (exit 2))
