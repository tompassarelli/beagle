...
real_workerd="${BEAGLE_STORE_CF_REAL_WORKERD:?set BEAGLE_STORE_CF_REAL_WORKERD}"
locator="${BEAGLE_STORE_CF_CGROUP_LOCATOR:?set BEAGLE_STORE_CF_CGROUP_LOCATOR}"
inventory="${BEAGLE_STORE_CF_CGROUP_INVENTORY:?set BEAGLE_STORE_CF_CGROUP_INVENTORY}"
limit_bytes=134217728
uid="$(id -u)"
base="/sys/fs/cgroup/user.slice/user-${uid}.slice/user@${uid}.service/app.slice"
group="$base/store-cloudflare-workerd-$$"
