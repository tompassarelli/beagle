...
writeFileSync(
  ...
  canonicalJson({
    ...
    pass: false,
    corpus: profile,
    loadPackets: progress.completedLoadPackets,
    verifyPackets: progress.completedVerifyPackets,
    responseBytes: 0,
    ...
    failure: {
      ...
      completedLoadPackets: progress.completedLoadPackets,
      completedVerifyPackets: progress.completedVerifyPackets,
