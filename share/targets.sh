...
BEAGLE_TARGET_IDS=(clj js nix core)
BEAGLE_HOSTED_TARGET_IDS=(clj js nix)
BEAGLE_TARGET_IDS_RE='clj|js|nix|core'
BEAGLE_TARGET_IDS_LIST='clj, js, nix, and core'
BEAGLE_TARGET_NAMES='Clojure, JavaScript, Nix, and Beagle Native Core (experimental)'
...
declare -A BEAGLE_TARGET_STATUS=([core]=experimental [clj]=live [js]=live [nix]=live)
