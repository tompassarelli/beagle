...
(defn run-tests! []
  ...
  (expect! "require: alias" (= (emit-require {"ns" "store.kernel" "alias" "k" "refer" nil}) "[store.kernel :as k]"))
  (expect! "require: default alias" (= (emit-require {"ns" "store.rt" "alias" nil "refer" nil}) "[store.rt :as rt]"))
