  ...
  (lambda (project-root _adapter-cache)
    ...
    (write-source!
     ...
     (string-append
      ...
      "(defrecord GeometryBatch [geometries (Vec ChildGeometry)])\n"
      "(defn emptyGeometryBatch [] GeometryBatch (->GeometryBatch []))\n"
      "(defn clearGeometryBatch [batch GeometryBatch] GeometryBatch\n"
      "  (with batch [:geometries []]))\n"
  ...
  (lambda (project-root adapter-cache)
    ...
    (write-source!
     ...
     (string-append
      ...
      "export interface Object3DEventMap { added: { object: Object3D }; }\n"
      "export interface LightEventMap extends Object3DEventMap { dispose: {}; }\n"
      "export declare class Object3D<TEventMap extends Object3DEventMap = Object3DEventMap> {\n"
      "  add(...object: Object3D<Object3DEventMap>[]): this;\n"
      "}\n"
      "export declare class Scene<TEventMap extends Object3DEventMap = Object3DEventMap> extends Object3D<TEventMap> {}\n"
      "export declare class Group<TEventMap extends Object3DEventMap = Object3DEventMap> extends Object3D<TEventMap> {}\n"
      "export declare class Light extends Object3D<LightEventMap> {}\n"
    ...
    (write-source!
     ...
     (string-append
      ...
      "  (:require [\"@fixture/native\" :refer [acceptFlag AmbientLight DirectionalLight Group loadBuffer loadText makeBytes notify Object3D Object3DEventMap pipeline PointLight Scene schedule stringTransformer value]]\n"
      ...
      "(js/export (defn addSceneObjects [scene SceneGraph one SceneGroup two SceneGroup three SceneGroup four SceneGroup ambient AmbientLight keyLight DirectionalLight emberLight PointLight wellLight PointLight] SceneGraph\n"
      "  (.add scene)\n"
      "  (.add scene one)\n"
      "  (.add scene one two three four ambient keyLight emberLight wellLight)))\n"
