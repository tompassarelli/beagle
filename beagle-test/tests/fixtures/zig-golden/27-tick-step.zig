...
pub fn tickStepAllRange(tick: std.mem.Allocator, seed: u64, tick_no: u64, in: *const SSoA, delta: i64, out: *SSoA, lo: usize, hi: usize) void {
    var i = lo;
    while (i < hi) : (i += 1) {
...
/// tick memory.
pub fn tickStepPromoteAll(out: *const SSoA, next: *SSoA, n: usize) void {
